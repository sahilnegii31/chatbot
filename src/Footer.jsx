    ...
    <>
      <div className='text-center mt-5 border-elegance-accent border-t-1 border-gray-500 pt-5 flex gap-5 flex-wrap justify-evenly h-fit w-full'>
        <div className='w-40 sm:w-fit'>
          <h2 className='text-4xl font-bold'>GroqAI</h2>
          <p className='text-elegance-text/75'>Smart tools. Real-time data. One powerful platform</p>          
        </div>
        <div className='w-40 sm:w-fit flex flex-col' id='contact'>
          <h2 className='text-4xl font-bold'>Quick Links</h2>
          <a href="#home" className='text-2xl' target='_blank'>Home</a>
          <a href="#features" className='text-2xl' target='_blank'>Features</a>
        </div>
        <div className='w-40 sm:w-fit flex flex-col'>
          <h2 className='text-4xl font-bold'>Social Links</h2>
          <a href="#home" className='text-2xl' target='_blank'>GitHub</a>
          <a href="#features" className='text-2xl' target='_blank'>LinkedIn</a>
